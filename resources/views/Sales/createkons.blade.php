            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    ...
                    <div class="container">
                        ...
                        <h2 >Form Input Konsumen </h2></div>
                        <div class="row items justify-content-center">
                            <div class="col-lg-6 ">
                            <form action="/salesKONSUMEN/konstambah" method="POST" enctype='multipart/form-data' >
                            @php echo csrf_field() @endphp
                                <div class="row">
                                    <div class="col-md-6 form-group">
                                    <input type="text" name="prshn" class="form-control" id="prshn" placeholder="Nama Perusahaan" required>
                                    </div>       
                                    <div class="col-md-6 form-group">
                                    <input type="text" name="npwp" class="form-control" id="npwp" placeholder="NPWP" required>
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-3">
                                    <input type="text" class="form-control" name="telp" id="telp" placeholder="No Telepon Kantor" required>
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-3">
                                        <input type="text" class="form-control" name="nama_cp" id="nama_cp" placeholder="Nama Kontak Person" required>
                                        </div>
                                    <div class="form-group mt-3">
                                    <input type="number" class="form-control" name="no_hp" id="no_hp" placeholder="No Handphone" required>
                                    </div>  
                                    <div class="form-group mt-3">
                                    <input type="email" class="form-control" name="email" id="email" placeholder="Email Perusahaan/Email Contact Person" required>
                                    </div>  
                                </div>
                                <div class="form-group mt-3">
                                    <textarea class="form-control" name="pesan" id="pesan" rows="5"placeholder="Pesanan" required></textarea>
                                </div>
                                <div class="form-group mt-3">
                                    <textarea class="form-control" name="alamat" id="alamat" rows="5"placeholder="Alamat Perusahaan" required></textarea>
                                </div>
                                <div class="form-group mt-3">
                                    <input type="text" class="form-control" name="ttl_hrg" id="ttl_hrg" placeholder="Total Harga" required>
                                </div>    
                                <p></p>   
                                <div class="text-center"><a href=/salesKONSUMEN/konstambah><button type="submit" class="btn btn-primary">Kirim</button></div>
                                </form>
                            </div>
