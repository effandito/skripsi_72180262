            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    ...
                    <div class="container">
                        ...
                        <h2 >Form Input Laporan Harian</h2></div>
                        <br/>
                        <div class="row items justify-content-center">
                            <div class="col-lg-6 ">
                            <form action="/sales/tambahlaporan" method="POST" enctype='multipart/form-data' >
                            @php echo csrf_field() @endphp
                                <div class="row">
                                    ...
                                    <input type="number" class="form-control" name="wkt_msk" id="wkt_msk" placeholder="Waktu Masuk" required>
                                    </div>  
                                    <div class="form-group mt-3">
                                    <input type="number" class="form-control" name="wkt_kel" id="wkt_kel" placeholder="Waktu Pulang" required>
                                    </div>   -->
                                ...
                                <div class="form-group mt-3">
                                    <textarea class="form-control" name="alamat_kunj" id="alamat_kunj" rows="5"placeholder="Alamat Perusahaan" required></textarea>
                                </div>
                                <p></p>   
            ...
            <h4 class="my-5">Data</h4>
				...
				<table class="table table-bordered table-striped">
					...
					<tbody>
						...
						<tr>
							<td><img width="150px" src="{{ url('/xampp/tmp/p/'.$l->file) }}"></td>
						</tr>
						@endforeach
					</tbody>
				</table>
