            ...
            <div id="page-content-wrapper">
                ...
                <nav class="navbar navbar-expand-lg navbar-light bg-light border-bottom">
                    ...
                    <!-- Page Heading -->
                        ...
                        <h2 >Form Edit Target </h2></div>
                        <div class="row items justify-content-center">
                            <div class="col-lg-6 ">
                            <form action="/DU/updatetarget" method="POST" enctype='multipart/form-data' >
                            @csrf
                            <input type="hidden" value="{{$target->id_target}}" name="id_target">
                               ...
                               <select class="form-control form-control-sm" placeholder="tahun" name="tahun" id="tahun">
                                ...
                                <div class="col-md-6  mt-md-3">
                                    ...
                                    <input type="text" name="nama" class="form-control" id="nama" placeholder="Nama" value="{{$target->nama}}" required>
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-3">
                                    <input type="number" class="form-control" name="target_jual" id="target_jual" placeholder="Target Penjualan" value="{{$target->target_jual}}"required>
                                    </div>
                                    <div class="col-md-6 form-group mt-3 mt-md-3">
                                    <input type="number" class="form-control" name="target_kunjung" id="target_kunjung" placeholder="Target Kunjungan" value="{{$target->target_kunjung}}" required>
                                    </div>
                                <p></p>   
