                ...
                <div class="card-body-md-6">
                    <div class="container">
                        ...
                        <div class="row items justify-content-center">
                            <div class="col-lg-6 ">
                            <form action="/hrdKARYAWAN/tmbh" method="POST" enctype='multipart/form-data' >
                            ...
                            <input type="hidden" value="{{$karyawan->id_karyawan}}" name="id">
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group">
                                    <input type="radio" name="jenis_klmn" id="Pria" value="Pria">Pria
                                    <input type="radio" name="jenis_klmn" id="Wanita  " value="Wanita">Wanita
                                    </select>
                                    </div>
                                    <div class="form-group mt-3">
                                    <select class="form-control form-control-sm" placeholder="Tempat Lahir" name="tempat_lhr" id="tempat_lhr" required>
                                    ...
                                    <input type="date" id="tgl_lahir" name="tgl_lahir" placeholder="tanggal lahir" value="{{$karyawan->tgl_lahir}}"></div>
                                    <div class="form-group mt-3">
                                    ...
                                    <div class="form-group mt-3">
                                    <select class="form-control form-control-sm" placeholder="pendidikan" name="pendidikan" id="pendidikan" value="{{$karyawan->no_ktp}}" required >
                                    ...
                                    <div class="form-group mt-3 md-8">
                                        <select class="form-control form-control-sm" placeholder="golongan darah" name="goldar" id="goldar" required>
                                    ...
                                    <div class="form-group mt-3">
                                    <input type="radio" name="status" id ="Aktif" value="Aktif">Aktif
                                    <input type="radio" name="status" id="Pensiun" value="Pensiun">Pensiun
                                    </div>
                                    </div>
                                    <div class="form-group mt-3">
                                    <select class="form-control form-control-sm" placeholder="Jumlah Anak" name="jml_ank" id="jml_ank" required>
                                            <option selected="">Pilih Jumlah Anak</option>
                                            <option>1</option>
                                            <option>2</option>
                                            <option>3</option>
                                            <option>4</option>
                                    ...
                                    <div class="form-group mt-3">
                                        <input type="text" class="form-control" name="nm_ats" id="nm_ats" placeholder="Nama Atasan" value="{{$karyawan->m_ats}}"required>
                                     </div>         
                                    </div>
                              
                                <p></p>   
                                <div class="text-center"><a href=/hrdKARYAWAN/tmbh><button type="submit" class="btn btn-primary">Kirim</button></div>
                                </form>
                                </div>
                    </div>
                                </div>
